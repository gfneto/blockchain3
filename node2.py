...
def add_transaction():
    try:
        ...
        if 'amount' in data:
            ...
            node2.blockchain.add_transaction(transaction)
...
# Create blockchain and node2
blockchain = Blockchain()
node2 = Node("192.168.1.203", 5000, blockchain)
...
threading.Thread(target=sync_loop, args=(node2, 5)).start()
